...
// jest.mock lets us replace stuff we don't control with stuff we do control
jest.mock('fs', () => ({
  promises: {
    // return a promise
    mkdir: jest.fn(() => Promise.resolve()),
    writeFile: jest.fn(() => Promise.resolve()),
    // promise always resolves to the included object, so that's what we test for
...
// checks to see if we called mkdir on the expected path
